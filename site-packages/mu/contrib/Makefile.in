...
build_triplet = @build@
host_triplet = @host@
noinst_PROGRAMS = gmime-test$(EXEEXT)
subdir = contrib
...
am_gmime_test_OBJECTS = gmime-test.$(OBJEXT)
gmime_test_OBJECTS = $(am_gmime_test_OBJECTS)
am__DEPENDENCIES_1 =
gmime_test_DEPENDENCIES = $(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1)
...
am__depfiles_remade = ./$(DEPDIR)/gmime-test.Po
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(gmime_test_SOURCES)
DIST_SOURCES = $(gmime_test_SOURCES)
...
gmime-test$(EXEEXT): $(gmime_test_OBJECTS) $(gmime_test_DEPENDENCIES) $(EXTRA_gmime_test_DEPENDENCIES) 
	@rm -f gmime-test$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(gmime_test_OBJECTS) $(gmime_test_LDADD) $(LIBS)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/gmime-test.Po@am__quote@ # am--include-marker
