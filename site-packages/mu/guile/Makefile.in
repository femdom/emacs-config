...
am__DEPENDENCIES_1 =
libguile_mu_la_DEPENDENCIES = ${top_builddir}/lib/libmu.la \
	$(am__DEPENDENCIES_1)
am_libguile_mu_la_OBJECTS = mu-guile.lo mu-guile-message.lo
libguile_mu_la_OBJECTS = $(am_libguile_mu_la_OBJECTS)
AM_V_lt = $(am__v_lt_@AM_V@)
am__v_lt_ = $(am__v_lt_@AM_DEFAULT_V@)
am__v_lt_0 = --silent
am__v_lt_1 = 
libguile_mu_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(AM_CFLAGS) $(CFLAGS) $(libguile_mu_la_LDFLAGS) $(LDFLAGS) -o \
	$@
...
am__depfiles_remade = ./$(DEPDIR)/mu-guile-message.Plo \
	./$(DEPDIR)/mu-guile.Plo
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(libguile_mu_la_SOURCES)
DIST_SOURCES = $(libguile_mu_la_SOURCES)
...
am__v_texidevnull_1 = 
INFO_DEPS = $(srcdir)/mu-guile.info
...
am__DIST_COMMON = $(mu_guile_TEXINFOS) $(srcdir)/Makefile.in \
	$(srcdir)/texi.texi.in $(top_srcdir)/build-aux/depcomp \
	$(top_srcdir)/build-aux/texinfo.tex $(top_srcdir)/gtest.mk
...
.SUFFIXES:
.SUFFIXES: .x .doc .c .dvi .html .info .lo .o .obj .pdf .ps .texi
...
$(ACLOCAL_M4):  $(am__aclocal_m4_deps)
	cd $(top_builddir) && $(MAKE) $(AM_MAKEFLAGS) am--refresh
$(am__aclocal_m4_deps):
texi.texi: $(top_builddir)/config.status $(srcdir)/texi.texi.in
...
libguile-mu.la: $(libguile_mu_la_OBJECTS) $(libguile_mu_la_DEPENDENCIES) $(EXTRA_libguile_mu_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libguile_mu_la_LINK) -rpath $(libdir) $(libguile_mu_la_OBJECTS) $(libguile_mu_la_LIBADD) $(LIBS)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-guile-message.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-guile.Plo@am__quote@ # am--include-marker
...
$(srcdir)/mu-guile.info: mu-guile.texi $(mu_guile_TEXINFOS)
mu-guile.dvi: mu-guile.texi $(mu_guile_TEXINFOS)
mu-guile.pdf: mu-guile.texi $(mu_guile_TEXINFOS)
mu-guile.html: mu-guile.texi $(mu_guile_TEXINFOS)
.dvi.ps:
...
mostlyclean-aminfo:
	-rm -rf mu-guile.t2d mu-guile.t2p

clean-aminfo:
	-test -z "mu-guile.dvi mu-guile.pdf mu-guile.ps mu-guile.html" \
	|| rm -rf mu-guile.dvi mu-guile.pdf mu-guile.ps mu-guile.html
...
all-am: Makefile $(INFO_DEPS) $(LTLIBRARIES) $(DATA)
installdirs: installdirs-recursive
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(infodir)" "$(DESTDIR)$(scmdir)"; do \
...
distclean: distclean-recursive
		-rm -f ./$(DEPDIR)/mu-guile-message.Plo
	-rm -f ./$(DEPDIR)/mu-guile.Plo
	-rm -f Makefile
...
install-data-am: install-info-am install-scmDATA
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	check-valgrind-sgcheck-local clean clean-aminfo clean-generic \
	...
	install-ps-am install-scmDATA install-strip installcheck \
	...
	uninstall-ps-am uninstall-scmDATA
