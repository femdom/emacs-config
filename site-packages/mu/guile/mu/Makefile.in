...
am__installdirs = "$(DESTDIR)$(scmdir)"
DATA = $(scm_DATA)
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/gtest.mk README
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/gtest.mk $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign guile/mu/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign guile/mu/Makefile
