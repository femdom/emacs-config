...
am__installdirs = "$(DESTDIR)$(muguiledistscriptdir)"
SCRIPTS = $(muguiledistscript_SCRIPTS)
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/gtest.mk
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/gtest.mk $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign guile/scripts/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign guile/scripts/Makefile
...
$(ACLOCAL_M4):  $(am__aclocal_m4_deps)
	cd $(top_builddir) && $(MAKE) $(AM_MAKEFLAGS) am--refresh
$(am__aclocal_m4_deps):
install-muguiledistscriptSCRIPTS: $(muguiledistscript_SCRIPTS)
	@$(NORMAL_INSTALL)
	@list='$(muguiledistscript_SCRIPTS)'; test -n "$(muguiledistscriptdir)" || list=; \
	if test -n "$$list"; then \
	...
	while read type dir files; do \
	     ...
	     test -z "$$files" || { \
	       echo " $(INSTALL_SCRIPT) $$files '$(DESTDIR)$(muguiledistscriptdir)$$dir'"; \
	       $(INSTALL_SCRIPT) $$files "$(DESTDIR)$(muguiledistscriptdir)$$dir" || exit $$?; \
	     } \
	; done

uninstall-muguiledistscriptSCRIPTS:
	@$(NORMAL_UNINSTALL)
	@list='$(muguiledistscript_SCRIPTS)'; test -n "$(muguiledistscriptdir)" || exit 0; \
	files=`for p in $$list; do echo "$$p"; done | \
	       sed -e 's,.*/,,;$(transform)'`; \
	dir='$(DESTDIR)$(muguiledistscriptdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(muguiledistscriptdir)"; do \
...
install-data-am: install-muguiledistscriptSCRIPTS
...
.PHONY: all all-am check check-am check-valgrind-am \
	...
	install-muguiledistscriptSCRIPTS install-pdf install-pdf-am \
