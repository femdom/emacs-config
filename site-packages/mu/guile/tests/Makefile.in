...
am__EXEEXT_1 = test-mu-guile$(EXEEXT)
PROGRAMS = $(noinst_PROGRAMS)
am_test_mu_guile_OBJECTS = test-mu-guile.$(OBJEXT) dummy.$(OBJEXT)
test_mu_guile_OBJECTS = $(am_test_mu_guile_OBJECTS)
test_mu_guile_DEPENDENCIES = ${top_builddir}/lib/libtestmucommon.la
...
am__v_CXXLD_1 = 
SOURCES = $(test_mu_guile_SOURCES)
DIST_SOURCES = $(test_mu_guile_SOURCES)
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/gtest.mk $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign guile/tests/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign guile/tests/Makefile
...
test-mu-guile$(EXEEXT): $(test_mu_guile_OBJECTS) $(test_mu_guile_DEPENDENCIES) $(EXTRA_test_mu_guile_DEPENDENCIES) 
	@rm -f test-mu-guile$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(test_mu_guile_OBJECTS) $(test_mu_guile_LDADD) $(LIBS)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-mu-guile.Po@am__quote@ # am--include-marker
