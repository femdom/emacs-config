...
build_triplet = @build@
host_triplet = @host@
noinst_PROGRAMS = tokenize$(EXEEXT) parse$(EXEEXT) $(am__EXEEXT_1)
TESTS = $(am__EXEEXT_1)
subdir = lib/query
...
am__EXEEXT_1 = test-tokenizer$(EXEEXT) test-parser$(EXEEXT)
PROGRAMS = $(noinst_PROGRAMS)
LTLIBRARIES = $(noinst_LTLIBRARIES)
am__DEPENDENCIES_1 =
libmu_query_la_DEPENDENCIES = $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	../utils/libmu-utils.la $(am__DEPENDENCIES_1)
am_libmu_query_la_OBJECTS = mu-parser.lo mu-tokenizer.lo mu-xapian.lo
libmu_query_la_OBJECTS = $(am_libmu_query_la_OBJECTS)
AM_V_lt = $(am__v_lt_@AM_V@)
am__v_lt_ = $(am__v_lt_@AM_DEFAULT_V@)
am__v_lt_0 = --silent
am__v_lt_1 = 
am_parse_OBJECTS = parse.$(OBJEXT)
parse_OBJECTS = $(am_parse_OBJECTS)
parse_DEPENDENCIES = $(am__DEPENDENCIES_1) libmu-query.la
am_test_parser_OBJECTS = test-parser.$(OBJEXT)
test_parser_OBJECTS = $(am_test_parser_OBJECTS)
test_parser_DEPENDENCIES = libmu-query.la
am_test_tokenizer_OBJECTS = test-tokenizer.$(OBJEXT)
test_tokenizer_OBJECTS = $(am_test_tokenizer_OBJECTS)
test_tokenizer_DEPENDENCIES = libmu-query.la
am_tokenize_OBJECTS = tokenize.$(OBJEXT)
tokenize_OBJECTS = $(am_tokenize_OBJECTS)
tokenize_DEPENDENCIES = $(am__DEPENDENCIES_1) libmu-query.la
...
am__depfiles_remade = ./$(DEPDIR)/mu-parser.Plo \
	./$(DEPDIR)/mu-tokenizer.Plo ./$(DEPDIR)/mu-xapian.Plo \
	./$(DEPDIR)/parse.Po ./$(DEPDIR)/test-parser.Po \
	./$(DEPDIR)/test-tokenizer.Po ./$(DEPDIR)/tokenize.Po
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(libmu_query_la_SOURCES) $(parse_SOURCES) \
	$(test_parser_SOURCES) $(test_tokenizer_SOURCES) \
	$(tokenize_SOURCES)
DIST_SOURCES = $(libmu_query_la_SOURCES) $(parse_SOURCES) \
	$(test_parser_SOURCES) $(test_tokenizer_SOURCES) \
	$(tokenize_SOURCES)
...
TEST_PROGS = test-tokenizer test-parser
AM_CXXFLAGS = \
	-I$(srcdir)/..		\
	-I$(top_srcdir)/lib	\
	$(GLIB_CFLAGS)		\
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/gtest.mk $(top_srcdir)/aminclude_static.am $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign lib/query/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign lib/query/Makefile
...
libmu-query.la: $(libmu_query_la_OBJECTS) $(libmu_query_la_DEPENDENCIES) $(EXTRA_libmu_query_la_DEPENDENCIES) 
	$(AM_V_CXXLD)$(CXXLINK)  $(libmu_query_la_OBJECTS) $(libmu_query_la_LIBADD) $(LIBS)

parse$(EXEEXT): $(parse_OBJECTS) $(parse_DEPENDENCIES) $(EXTRA_parse_DEPENDENCIES) 
	@rm -f parse$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(parse_OBJECTS) $(parse_LDADD) $(LIBS)
...
test-tokenizer$(EXEEXT): $(test_tokenizer_OBJECTS) $(test_tokenizer_DEPENDENCIES) $(EXTRA_test_tokenizer_DEPENDENCIES) 
	@rm -f test-tokenizer$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(test_tokenizer_OBJECTS) $(test_tokenizer_LDADD) $(LIBS)

tokenize$(EXEEXT): $(tokenize_OBJECTS) $(tokenize_DEPENDENCIES) $(EXTRA_tokenize_DEPENDENCIES) 
	@rm -f tokenize$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(tokenize_OBJECTS) $(tokenize_LDADD) $(LIBS)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-parser.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-tokenizer.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-xapian.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/parse.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-parser.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-tokenizer.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/tokenize.Po@am__quote@ # am--include-marker
...
recheck: all 
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
test-tokenizer.log: test-tokenizer$(EXEEXT)
	@p='test-tokenizer$(EXEEXT)'; \
	b='test-tokenizer'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
test-parser.log: test-parser$(EXEEXT)
...
distclean: distclean-am
		-rm -f ./$(DEPDIR)/mu-parser.Plo
	-rm -f ./$(DEPDIR)/mu-tokenizer.Plo
	-rm -f ./$(DEPDIR)/mu-xapian.Plo
	-rm -f ./$(DEPDIR)/parse.Po
	-rm -f ./$(DEPDIR)/test-parser.Po
	-rm -f ./$(DEPDIR)/test-tokenizer.Po
	-rm -f ./$(DEPDIR)/tokenize.Po
	-rm -f Makefile
