...
am__EXEEXT_1 = test-mu-util$(EXEEXT) test-mu-utils$(EXEEXT) \
	test-mu-str$(EXEEXT) test-sexp-parser$(EXEEXT) \
	test-command-parser$(EXEEXT)
PROGRAMS = $(noinst_PROGRAMS)
LTLIBRARIES = $(noinst_LTLIBRARIES)
am__DEPENDENCIES_1 =
libmu_utils_la_DEPENDENCIES = $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1)
am_libmu_utils_la_OBJECTS = mu-date.lo mu-log.lo mu-command-parser.lo \
	mu-sexp-parser.lo mu-str.lo mu-util.lo mu-utils.lo
libmu_utils_la_OBJECTS = $(am_libmu_utils_la_OBJECTS)
AM_V_lt = $(am__v_lt_@AM_V@)
am__v_lt_ = $(am__v_lt_@AM_DEFAULT_V@)
am__v_lt_0 = --silent
am__v_lt_1 = 
am_test_command_parser_OBJECTS = test-command-parser.$(OBJEXT)
test_command_parser_OBJECTS = $(am_test_command_parser_OBJECTS)
test_command_parser_DEPENDENCIES = libmu-utils.la
am_test_mu_str_OBJECTS = test-mu-str.$(OBJEXT)
test_mu_str_OBJECTS = $(am_test_mu_str_OBJECTS)
test_mu_str_DEPENDENCIES = libmu-utils.la
am_test_mu_util_OBJECTS = test-mu-util.$(OBJEXT)
test_mu_util_OBJECTS = $(am_test_mu_util_OBJECTS)
test_mu_util_DEPENDENCIES = libmu-utils.la
am_test_mu_utils_OBJECTS = test-utils.$(OBJEXT)
test_mu_utils_OBJECTS = $(am_test_mu_utils_OBJECTS)
test_mu_utils_DEPENDENCIES = libmu-utils.la
am_test_sexp_parser_OBJECTS = test-sexp-parser.$(OBJEXT)
test_sexp_parser_OBJECTS = $(am_test_sexp_parser_OBJECTS)
test_sexp_parser_DEPENDENCIES = libmu-utils.la
...
am__depfiles_remade = ./$(DEPDIR)/mu-command-parser.Plo \
	./$(DEPDIR)/mu-date.Plo ./$(DEPDIR)/mu-log.Plo \
	./$(DEPDIR)/mu-sexp-parser.Plo ./$(DEPDIR)/mu-str.Plo \
	./$(DEPDIR)/mu-util.Plo ./$(DEPDIR)/mu-utils.Plo \
	./$(DEPDIR)/test-command-parser.Po ./$(DEPDIR)/test-mu-str.Po \
	./$(DEPDIR)/test-mu-util.Po ./$(DEPDIR)/test-sexp-parser.Po \
	./$(DEPDIR)/test-utils.Po
am__mv = mv -f
...
am__v_CXXLD_1 = 
SOURCES = $(libmu_utils_la_SOURCES) $(test_command_parser_SOURCES) \
	$(test_mu_str_SOURCES) $(test_mu_util_SOURCES) \
	$(test_mu_utils_SOURCES) $(test_sexp_parser_SOURCES)
DIST_SOURCES = $(libmu_utils_la_SOURCES) \
	$(test_command_parser_SOURCES) $(test_mu_str_SOURCES) \
	$(test_mu_util_SOURCES) $(test_mu_utils_SOURCES) \
...
TEST_PROGS = test-mu-util test-mu-utils test-mu-str test-sexp-parser \
	test-command-parser
AM_CFLAGS = \
	$(WARN_CFLAGS)						\
	$(GLIB_CFLAGS)						\
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/gtest.mk $(top_srcdir)/aminclude_static.am $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign lib/utils/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign lib/utils/Makefile
...
libmu-utils.la: $(libmu_utils_la_OBJECTS) $(libmu_utils_la_DEPENDENCIES) $(EXTRA_libmu_utils_la_DEPENDENCIES) 
	$(AM_V_CXXLD)$(CXXLINK)  $(libmu_utils_la_OBJECTS) $(libmu_utils_la_LIBADD) $(LIBS)

test-command-parser$(EXEEXT): $(test_command_parser_OBJECTS) $(test_command_parser_DEPENDENCIES) $(EXTRA_test_command_parser_DEPENDENCIES) 
	@rm -f test-command-parser$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(test_command_parser_OBJECTS) $(test_command_parser_LDADD) $(LIBS)

test-mu-str$(EXEEXT): $(test_mu_str_OBJECTS) $(test_mu_str_DEPENDENCIES) $(EXTRA_test_mu_str_DEPENDENCIES) 
	@rm -f test-mu-str$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(test_mu_str_OBJECTS) $(test_mu_str_LDADD) $(LIBS)
...
test-mu-util$(EXEEXT): $(test_mu_util_OBJECTS) $(test_mu_util_DEPENDENCIES) $(EXTRA_test_mu_util_DEPENDENCIES) 
	...
	$(AM_V_CCLD)$(LINK) $(test_mu_util_OBJECTS) $(test_mu_util_LDADD) $(LIBS)

test-mu-utils$(EXEEXT): $(test_mu_utils_OBJECTS) $(test_mu_utils_DEPENDENCIES) $(EXTRA_test_mu_utils_DEPENDENCIES) 
	@rm -f test-mu-utils$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(test_mu_utils_OBJECTS) $(test_mu_utils_LDADD) $(LIBS)

test-sexp-parser$(EXEEXT): $(test_sexp_parser_OBJECTS) $(test_sexp_parser_DEPENDENCIES) $(EXTRA_test_sexp_parser_DEPENDENCIES) 
	@rm -f test-sexp-parser$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(test_sexp_parser_OBJECTS) $(test_sexp_parser_LDADD) $(LIBS)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-command-parser.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-date.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-log.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-sexp-parser.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-str.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-util.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-utils.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-command-parser.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-mu-str.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-mu-util.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-sexp-parser.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/test-utils.Po@am__quote@ # am--include-marker
...
recheck: all 
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
test-mu-util.log: test-mu-util$(EXEEXT)
	@p='test-mu-util$(EXEEXT)'; \
	b='test-mu-util'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
test-mu-utils.log: test-mu-utils$(EXEEXT)
	@p='test-mu-utils$(EXEEXT)'; \
	b='test-mu-utils'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
test-mu-str.log: test-mu-str$(EXEEXT)
	@p='test-mu-str$(EXEEXT)'; \
	b='test-mu-str'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
test-sexp-parser.log: test-sexp-parser$(EXEEXT)
	@p='test-sexp-parser$(EXEEXT)'; \
	b='test-sexp-parser'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
test-command-parser.log: test-command-parser$(EXEEXT)
	@p='test-command-parser$(EXEEXT)'; \
	b='test-command-parser'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
...
distclean: distclean-am
		-rm -f ./$(DEPDIR)/mu-command-parser.Plo
	-rm -f ./$(DEPDIR)/mu-date.Plo
	-rm -f ./$(DEPDIR)/mu-log.Plo
	-rm -f ./$(DEPDIR)/mu-sexp-parser.Plo
	-rm -f ./$(DEPDIR)/mu-str.Plo
	-rm -f ./$(DEPDIR)/mu-util.Plo
	-rm -f ./$(DEPDIR)/mu-utils.Plo
	-rm -f ./$(DEPDIR)/test-command-parser.Po
	-rm -f ./$(DEPDIR)/test-mu-str.Po
	-rm -f ./$(DEPDIR)/test-mu-util.Po
	-rm -f ./$(DEPDIR)/test-sexp-parser.Po
	-rm -f ./$(DEPDIR)/test-utils.Po
	-rm -f Makefile
