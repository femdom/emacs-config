...
am__DEPENDENCIES_1 =
libmuwidgets_la_DEPENDENCIES = ${top_builddir}/lib/libmu.la \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1)
am_libmuwidgets_la_OBJECTS = mu-widget-util.lo mu-msg-attach-view.lo \
	mu-msg-body-view.lo mu-msg-header-view.lo mu-msg-view.lo
libmuwidgets_la_OBJECTS = $(am_libmuwidgets_la_OBJECTS)
AM_V_lt = $(am__v_lt_@AM_V@)
am__v_lt_ = $(am__v_lt_@AM_DEFAULT_V@)
am__v_lt_0 = --silent
am__v_lt_1 = 
am_mug_OBJECTS = mug.$(OBJEXT) mug-msg-list-view.$(OBJEXT) \
	mug-msg-view.$(OBJEXT) mug-query-bar.$(OBJEXT) \
	mug-shortcuts.$(OBJEXT) dummy.$(OBJEXT)
mug_OBJECTS = $(am_mug_OBJECTS)
mug_DEPENDENCIES = $(am__DEPENDENCIES_1) ${top_builddir}/lib/libmu.la \
	libmuwidgets.la $(am__DEPENDENCIES_1)
...
am__depfiles_remade = ./$(DEPDIR)/dummy.Po \
	./$(DEPDIR)/mu-msg-attach-view.Plo \
	./$(DEPDIR)/mu-msg-body-view.Plo \
	./$(DEPDIR)/mu-msg-header-view.Plo ./$(DEPDIR)/mu-msg-view.Plo \
	./$(DEPDIR)/mu-widget-util.Plo \
	./$(DEPDIR)/mug-msg-list-view.Po ./$(DEPDIR)/mug-msg-view.Po \
	./$(DEPDIR)/mug-query-bar.Po ./$(DEPDIR)/mug-shortcuts.Po \
	./$(DEPDIR)/mug.Po
am__mv = mv -f
...
am__v_CXXLD_1 = 
SOURCES = $(libmuwidgets_la_SOURCES) $(mug_SOURCES)
DIST_SOURCES = $(libmuwidgets_la_SOURCES) $(mug_SOURCES)
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(top_srcdir)/build-aux/depcomp $(top_srcdir)/gtest.mk
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/gtest.mk $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign toys/mug/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign toys/mug/Makefile
...
libmuwidgets.la: $(libmuwidgets_la_OBJECTS) $(libmuwidgets_la_DEPENDENCIES) $(EXTRA_libmuwidgets_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(LINK)  $(libmuwidgets_la_OBJECTS) $(libmuwidgets_la_LIBADD) $(LIBS)

mug$(EXEEXT): $(mug_OBJECTS) $(mug_DEPENDENCIES) $(EXTRA_mug_DEPENDENCIES) 
	@rm -f mug$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(mug_OBJECTS) $(mug_LDADD) $(LIBS)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-msg-attach-view.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-msg-body-view.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-msg-header-view.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-msg-view.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mu-widget-util.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mug-msg-list-view.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mug-msg-view.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mug-query-bar.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mug-shortcuts.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/mug.Po@am__quote@ # am--include-marker
...
distclean: distclean-recursive
	...
	-rm -f ./$(DEPDIR)/mu-msg-attach-view.Plo
	-rm -f ./$(DEPDIR)/mu-msg-body-view.Plo
	-rm -f ./$(DEPDIR)/mu-msg-header-view.Plo
	-rm -f ./$(DEPDIR)/mu-msg-view.Plo
	-rm -f ./$(DEPDIR)/mu-widget-util.Plo
	-rm -f ./$(DEPDIR)/mug-msg-list-view.Po
	-rm -f ./$(DEPDIR)/mug-msg-view.Po
	-rm -f ./$(DEPDIR)/mug-query-bar.Po
	-rm -f ./$(DEPDIR)/mug-shortcuts.Po
	-rm -f ./$(DEPDIR)/mug.Po
	-rm -f Makefile
